<div class="container">
    ...
    <?php
        ...
        if(isset($_SESSION['flashed_add_submission']) && count($_SESSION['flashed_add_submission']) > 0){
            $flashed_data = $_SESSION['flashed_add_submission'];
        ...
        if(isset($_SESSION['errors_add_submission']) && count($_SESSION['errors_add_submission']) > 0){
            foreach($_SESSION['errors_add_submission'] as $error){
    ?>
    ...
    ?>
    <form action="/submissions/add" method="POST">
